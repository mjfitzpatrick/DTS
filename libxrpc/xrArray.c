...
/**
 *  XR_SETLONGLONGINARRAY -- Set a long in an array.
 *
 *  @fn     void xr_setLongLongInArray (int anum, long long value)
 */
void
xr_setLongLongInArray ( int anum, long long value)
{

 AElement *a = &aElements[anum];
    xmlrpc_value *v = xmlrpc_i8_new (&env, (long long const)value);
    xmlrpc_array_append_item(&env,a->val,v);
    xmlrpc_DECREF(v);
}
...
/**
 *  XR_GETLONGLONGFROMARRAY -- Get a long from an array.
 *
 *  @fn     void xr_getLongLongFromArray (int anum, int index, long long *dval)
 */
void
xr_getLongLongFromArray (int anum, int index, long long *llval)
{
    AElement *a = &aElements[anum];
    xmlrpc_value *v;
